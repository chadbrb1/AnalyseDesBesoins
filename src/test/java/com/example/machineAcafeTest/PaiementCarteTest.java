...
//            "ET un café coule")
//    public void TestCafeCB(){
//        //ETANT DONNE une machine reliée à un module sans-contact répondant toujours ok
//        var modulePaiement = new ModulePaiementSpy(ModulePaiementMock(true));
//
//
...
//
//        // ET un café coule
//        int nombreCafésFinaux = machine.GetNombreCafesServis();
//        assertEquals(nombreCafeInitiaux + 1, nombreCafésFinaux);
//    }
//}
